...
pure_parser_examples: dir_create PureScanner.o PureParser.o pure_parser.o
	$(COMPILE) $(DIR)/PureScanner.o $(DIR)/PureParser.o $(DIR)/pure_parser.o c_wrapper/pure_parser_examples.c -o $(DIR)/pure_parser_examples
